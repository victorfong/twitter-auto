...
func (_m *MockTwitter) GetUsersShowById(userId int64) (anaconda.User, error) {
	ret := _m.ctrl.Call(_m, "GetUsersShowById", userId)
	ret0, _ := ret[0].(anaconda.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockTwitterRecorder) GetUsersShowById(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetUsersShowById", arg0)
}
